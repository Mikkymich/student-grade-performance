# -*- coding: utf-8 -*-
"""
Created on Fri Dec  8 09:01:45 2023
...
def predict_grade(data:StudentInfo):
    ...
    prediction = model.predict([[sex,age,address,famsize,Pstatus,Medu,Fedu,Mjob,Fjob,reason,guardian,traveltime,studytime,failures,schoolsup,famsup,paid,activities,nursery,higher,internet,romantic,famrel,freetime,goout,Dalc,Walc,health,absences,G1,G2]])
